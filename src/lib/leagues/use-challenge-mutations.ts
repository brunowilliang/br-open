...
export function useChallengeMutations(input: UseChallengeMutationsInput) {
  ...
  const counterProposeChallenge = useMutation({
    mutationFn: crpcClient.league.challenges.counterPropose.mutate,
    mutationKey: crpc.league.challenges.counterPropose.mutationKey(),
    onError: (error) => {
      toast.show({
        description: getToastErrorMessage(
          error,
    ...
    onSuccess: async () => {
      await invalidateLeagueContext();
      toast.show({
        description: "Seu adversário pode aceitar ou recusar a nova proposta.",
  ...
  const cancelChallenge = useMutation({
    mutationFn: crpcClient.league.challenges.cancel.mutate,
    mutationKey: crpc.league.challenges.cancel.mutationKey(),
    onError: (error) => {
      toast.show({
        description: getToastErrorMessage(
          error,
  ...
  const requestChallengeCancellation = useMutation({
    mutationFn: crpcClient.league.challenges.requestCancellation.mutate,
    mutationKey: crpc.league.challenges.requestCancellation.mutationKey(),
    onError: (error) => {
      toast.show({
        description: getToastErrorMessage(
          error,
    ...
    onSuccess: async () => {
      await invalidateLeagueContext();
      toast.show({
        description: "Seu adversário será notificado para aceitar ou recusar.",
  ...
  const submitChallengeResult = useMutation({
    mutationFn: crpcClient.league.challenges.submitResult.mutate,
    mutationKey: crpc.league.challenges.submitResult.mutationKey(),
    onError: (error) => {
      toast.show({
        description: getToastErrorMessage(
          error,
  ...
  const reviewChallenge = useMutation({
    mutationFn: crpcClient.league.challenges.reviewChallenge.mutate,
    mutationKey: crpc.league.challenges.reviewChallenge.mutationKey(),
    onError: (error) => {
      toast.show({
        description: getToastErrorMessage(
          error,
  ...
  const reviewChallengeResult = useMutation({
    mutationFn: crpcClient.league.challenges.reviewResult.mutate,
    mutationKey: crpc.league.challenges.reviewResult.mutationKey(),
    onError: (error) => {
      toast.show({
        description: getToastErrorMessage(
          error,
  ...
  const organizerManageChallenge = useMutation({
    mutationFn: crpcClient.league.challenges.organizerManage.mutate,
    mutationKey: crpc.league.challenges.organizerManage.mutationKey(),
  ...
  const organizerSubmitChallengeResult = useMutation({
    mutationFn: crpcClient.league.challenges.organizerSubmitResult.mutate,
    mutationKey: crpc.league.challenges.organizerSubmitResult.mutationKey(),
    onError: (error) => {
      toast.show({
        description: getToastErrorMessage(
          error,
  ...
  const organizerRequestResultReminder = useMutation({
    mutationFn:
      crpcClient.league.challenges.organizerRequestResultReminder.mutate,
    mutationKey:
      crpc.league.challenges.organizerRequestResultReminder.mutationKey(),
    onError: (error) => {
      toast.show({
        description: getToastErrorMessage(
          error,
