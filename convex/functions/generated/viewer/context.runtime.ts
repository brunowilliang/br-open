...
const procedureRegistry = {
  "activateOrganization": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../../viewer/context").activateOrganization>("viewer/context:activateOrganization"), () => (require("../../viewer/context") as Record<string, unknown>)["activateOrganization"])],
  "get": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../../viewer/context").get>("viewer/context:get"), () => (require("../../viewer/context") as Record<string, unknown>)["get"])],
  "setActiveActor": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../../viewer/context").setActiveActor>("viewer/context:setActiveActor"), () => (require("../../viewer/context") as Record<string, unknown>)["setActiveActor"])],
} as const;
...
export function createViewerContextCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createViewerContextHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
