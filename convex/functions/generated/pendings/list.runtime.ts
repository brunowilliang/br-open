...
const procedureRegistry = {
  "list": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../../pendings/list").list>("pendings/list:list"), () => (require("../../pendings/list") as Record<string, unknown>)["list"])],
} as const;
...
export function createPendingsListCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createPendingsListHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
