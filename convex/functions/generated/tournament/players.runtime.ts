...
const procedureRegistry = {
  "searchByUsername": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../../tournament/players").searchByUsername>("tournament/players:searchByUsername"), () => (require("../../tournament/players") as Record<string, unknown>)["searchByUsername"])],
} as const;
...
export function createTournamentPlayersCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createTournamentPlayersHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
