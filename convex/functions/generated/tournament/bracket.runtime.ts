...
export function createTournamentBracketCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createTournamentBracketHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
