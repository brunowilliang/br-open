...
export function createLeagueDiscoveryCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createLeagueDiscoveryHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
