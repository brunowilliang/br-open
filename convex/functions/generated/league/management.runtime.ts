...
const procedureRegistry = {
  ...
  "update": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../../league/management").update>("league/management:update"), () => (require("../../league/management") as Record<string, unknown>)["update"])],
} as const;
...
export function createLeagueManagementCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createLeagueManagementHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
